...
>) {
  ...
  const highlight = "radial-gradient(75% 181.15942028985506% at 50% 50%, #D4AF37 0%, rgba(255, 255, 255, 0) 100%)";
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-xl content-center bg-transparent transition-all duration-500 w-full h-full overflow-hidden z-0",
        containerClassName
      )}
      {...props}
    >
      <div
        className={cn(
          "w-full h-full z-10 bg-white dark:bg-neutral-900 rounded-[inherit] relative",
          className
        )}
      >
        {children}
